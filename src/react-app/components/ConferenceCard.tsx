    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
      <div className="p-6">
        ...
        <div className="mt-4 space-y-3">
          <div className="flex items-center text-zinc-700 mb-3">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-zinc-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="flex items-start mb-3">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-zinc-500 flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div>
              ...
              {metadata?.end_date && (
                <div>End: {formatDate(metadata.end_date)}</div>
              )}
            </div>
          </div>
          ...
          <div className="flex items-start mb-3">
            ...
            <div>
              ...
              {metadata?.abstract_deadline && (
                <div>Abstract: {formatDate(metadata.abstract_deadline)}</div>
              )}
              <div className={getDeadlineStatus()}>
                Paper: {formatDate(paper_deadline)}
          ...
          <div className="flex items-start mb-3">
            ...
            <div>
              ...
              <div>{conference.location || 'Not specified'}</div>
            </div>
          </div>
          ...
          {metadata && Object.keys(metadata).filter(key =>
            !['location', 'website', 'end_date', 'abstract_deadline'].includes(key)
          ).length > 0 && (
              <div className="flex items-start mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-zinc-500 flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div>
                  ...
                  {Object.entries(metadata).map(([key, value]) => {
                    if (!['location', 'website', 'end_date', 'abstract_deadline'].includes(key)) {
                      return (
