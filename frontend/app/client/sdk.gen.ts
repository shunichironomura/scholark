...
export const conferencesUpdateTagsForConference = <ThrowOnError extends boolean = false>(options: Options<ConferencesUpdateTagsForConferenceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<ConferencesUpdateTagsForConferenceResponse, ConferencesUpdateTagsForConferenceError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const tagsDeleteTag = <ThrowOnError extends boolean = false>(options: Options<TagsDeleteTagData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<TagsDeleteTagResponse, TagsDeleteTagError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
